            ...
            if($odmpro_update_csv_link && $config_odmpro_tamplate_data){
                ...
                foreach ($update_settings as $setting) {
                    ...
                    if($setting['token']==$token){
                        ...
                        if(!$odmpro_tamplate_data['file_upload_this'] && $odmpro_tamplate_data && !isset($this->request->get['export']) && !isset($this->request->get['start']) && $this->anyxls && isset($odmpro_tamplate_data['anyxls_xls_upload']) && $odmpro_tamplate_data['anyxls_xls_upload']){
                        ...
                        if(!$odmpro_tamplate_data['file_upload_this'] && $odmpro_tamplate_data && !isset($this->request->get['export']) && !isset($this->request->get['start']) && isset($odmpro_tamplate_data['anyyml_yml_upload']) && $odmpro_tamplate_data['anyyml_yml_upload']){
