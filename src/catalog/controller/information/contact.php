...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		$data['inn'] = $this->config->get('config_inn');
		$data['ogrn'] = $this->config->get('config_ogrn');
    ...
    public function send() {
        ...
        if (!isset($this->request->post['email']) || empty($this->request->post['email'])) {
            $json['error'] = "Поле email не должно быть пустым";
        }
        ...
        if (!isset($this->request->post['consent']) || empty($this->request->post['consent'])) {
            $json['error'] = "Вы должны дать согласие на обработку персональных данных.";
        }
        ...
        if (!isset($json['error'])) {
            ...
            $text = "<b>" . $this->request->post['name'] . "</b> оставил заявку на обратный звонок , пожалуйста перезвоните по номеру " . $this->request->post['phone'] . '<br><br>' . '<b>email:</b> ' .$this->request->post['email'];
            if (isset($this->request->post['comment'])){
                $text .= '<br><br><b>Комментарий:</b><br>' . $this->request->post['comment'];
            }
