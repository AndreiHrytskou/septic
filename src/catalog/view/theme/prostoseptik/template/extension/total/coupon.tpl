<div class="coupon">
  <input type="text" name="coupon" class="input-text" id="coupon_code" value="<?php echo $coupon; ?>" placeholder="Код купона">
  <button id="button-coupon" type="submit" class="button" name="apply_coupon">Применить</button>
</div>
