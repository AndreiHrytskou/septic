              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="url" value="<?php echo isset($url) ? $url : ''; ?>" placeholder="<?php echo $entry_url; ?>" id="input-url; ?>" class="form-control" />
                      <?php if (isset($error_url) && $error_url != '') { ?>
                      <div class="text-danger"><?php echo $error_url; ?></div>
                      <?php } ?>
                    </div>
                  </div>
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-url"><?php echo $entry_preview; ?></label>
                    <div class="col-sm-10">
                      <a href="" id="thumb-image-1" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                        <input type="hidden" name="preview" value="<?php echo $preview; ?>" id="input-image" />
                      <?php if (isset($error_preview) && $error_preview != '') { ?>
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="video_description[<?php echo $language['language_id']; ?>][meta_h1]" value="<?php echo isset($video_description[$language['language_id']]) ? $video_description[$language['language_id']]['meta_h1'] : ''; ?>" placeholder="<?php echo $entry_meta_h1; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
