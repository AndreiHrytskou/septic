          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_inn" value="<?php echo $config_inn; ?>" placeholder="<?php echo $entry_inn; ?>" id="input-inn" class="form-control" />
                  <?php if ($error_inn) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ogrn"><?php echo $entry_ogrn; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_ogrn" value="<?php echo $config_ogrn; ?>" placeholder="<?php echo $entry_ogrn; ?>" id="input-ogrn" class="form-control" />
                  <?php if ($error_ogrn) { ?>
                  <div class="text-danger"><?php echo $error_ogrn; ?></div>
                  <?php } ?>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <?php if ($error_vk) { ?>
                  <div class="text-danger"><?php echo $error_vk; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-dzen"><?php echo $entry_dzen; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_dzen" value="<?php echo $config_dzen; ?>" placeholder="<?php echo $entry_dzen; ?>" id="input-dzen" class="form-control" />
                  <?php if ($error_dzen) { ?>
                  <div class="text-danger"><?php echo $error_dzen; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-rutube"><?php echo $entry_rutube; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_rutube" value="<?php echo $config_rutube; ?>" placeholder="<?php echo $entry_rutube; ?>" id="input-rutube" class="form-control" />
                  <?php if ($error_rutube) { ?>
                  <div class="text-danger"><?php echo $error_rutube; ?></div>
                  <?php } ?>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-footer"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_footer; ?>"><?php echo $entry_footer; ?></span></label>
                <div class="col-sm-10">
                  <textarea name="config_footer" rows="5" placeholder="<?php echo $entry_footer; ?>" id="input-footer" class="form-control"><?php echo $config_footer; ?></textarea>
                </div>
              </div>
              <?php if ($locations) { ?>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-admin-photo"><span data-toggle="tooltip" title="<?php echo $help_limit_photo; ?>"><?php echo $entry_limit_photo; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_limit_photo" value="<?php echo $config_limit_photo; ?>" placeholder="<?php echo $entry_limit_photo; ?>" id="input-admin-photo" class="form-control" />
                    <?php if ($error_limit_photo) { ?>
                    <div class="text-danger"><?php echo $error_limit_photo; ?></div>
                    <?php } ?>
                  </div>
                </div>
              </fieldset>
