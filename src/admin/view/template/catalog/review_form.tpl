    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-url"><?php echo $entry_avatar; ?></label>
            <div class="col-sm-10">
              ...
              <input type="hidden" name="avatar" value="<?php echo $avatar; ?>" id="input-image" />
              <?php if (isset($error_avatar) && $error_avatar != '') { ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_public; ?></label>
            <div class="col-sm-10">
              <select name="public" id="input-public" class="form-control">
                <?php if ($public) { ?>
