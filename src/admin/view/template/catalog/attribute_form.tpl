...
<!--            Иконка-->
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img width="16" height="16" src="<?php echo $image['thumb']; ?>" alt="" title="" data-placeholder="Выберите изображение" /></a>
                    <input id="input-image" type="hidden" name="icon" value="<?= $icon !== '' ? $icon : $image['thumb'] ?>" placeholder="<?php echo $entry_icon; ?>" id="input-sort-order" class="form-control" />
                </div>
            </div>
            <!--            Иконка-->
<!--          <div class="form-group">-->
...
<!--            <label class="col-sm-2 control-label" for="input-sort-order">--><?php //echo $entry_icon; ?><!--</label>-->
<!--            <div class="col-sm-10">-->
<!--                <a href="" id="thumb-image-0" data-toggle="image" class="img-thumbnail"><img src="--><?php //echo $image['thumb']; ?><!--" alt="" title="" data-placeholder="Выберите изображение" /></a>-->
<!--                    <input type="hidden" name="attribute_description[--><?php //echo $language['language_id']; ?><!--][icon]" value="--><?php //echo isset($attribute_description[$language['language_id']]) ? $attribute_description[$language['language_id']]['icon'] : ''; ?><!--" id="input-image0" />-->
<!--            </div>-->
              <!--              иконка-->
<!--          </div>-->
