                ...
                <tr>
                    ...
                    <td class="text-left">
                        ...
                        <div <?php echo $export_css; ?> >
                            ...
                            <div class="input-group  export_boxes"  style="width: 100%" id="export_box2_csv">
...
<tr>
                        <td>Фильтрация данных для импорта</td>
                        <td>
                            ...
                            <?php for($i=0;$i<$count_group_id_box;$i++){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="input-group" >
                                                    <select name="odmpro_tamplate_data[filter_box][product_data][<?php echo $i ?>][product_field]"  class="form-control ">
                                                        <option value="0" ><?php echo $text_type_data_ignor; ?></option>
                                                            <?php foreach($product_fields_group_id_box as $product_field => $product_value){ ?>
                                                                <?php if(isset($tamplate_data_selected['filter_box']['product_data'][$i]['product_field']) && $tamplate_data_selected['filter_box']['product_data'][$i]['product_field']==$product_field ){ ?>
                                                        <option value="<?php echo $product_field ?>" selected="" ><?php echo $product_value; ?></option>
                                                                <?php }else{ ?>
                                                        <option value="<?php echo $product_field ?>" ><?php echo $product_value; ?></option> 
                                                                <?php } ?>
                                            ...
                                            <td>
                                                ...
                                                <div class="input-group" >
                                                    <select name="odmpro_tamplate_data[filter_box][product_data][<?php echo $i ?>][operator]"  class="form-control ">
                                                        <option value="0" ><?php echo $text_type_data_ignor; ?></option>
                                                            <?php foreach($operators_group_id_box as $product_field => $product_value){ ?>
                                                                <?php if(isset($tamplate_data_selected['filter_box']['product_data'][$i]['operator']) && $tamplate_data_selected['filter_box']['product_data'][$i]['operator']==$product_field ){ ?>
                                                        <option value="<?php echo $product_field ?>" selected="" ><?php echo $product_value; ?></option>
                                                                <?php }else{ ?>
                                                        <option value="<?php echo $product_field ?>" ><?php echo $product_value; ?></option> 
                                                                <?php } ?>
                                            ...
                                            <td>
                                                ...
                                                <div class="input-group" >
                                                    ...
                                                    <?php if(isset($tamplate_data_selected['filter_box']['product_data'][$i]['value']) && $tamplate_data_selected['filter_box']['product_data'][$i]['value'] ){ ?>
                                                        <input name="odmpro_tamplate_data[filter_box][product_data][<?php echo $i ?>][value]"  value="<?php echo $tamplate_data_selected['filter_box']['product_data'][$i]['value'] ?>" class="form-control " type="text" />
                                                    <?php }else{ ?>
                                                        <input name="odmpro_tamplate_data[filter_box][product_data][<?php echo $i ?>][value]" value=""  class="form-control " type="text" />
                                                    <?php } ?>
