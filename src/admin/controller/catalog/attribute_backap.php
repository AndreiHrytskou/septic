...
//            $icon = $data['attribute_description'][$lang_id]['icon'];
...
//            if ((utf8_strlen($value['icon']) < 3) || (utf8_strlen($value['icon']) > 64)) {
...
//					'icon'            => strip_tags(html_entity_decode($result['icon'], ENT_QUOTES, 'UTF-8')),
					'attribute_group' => $result['attribute_group']
				);
			}
		}
