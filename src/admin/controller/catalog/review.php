...
class ControllerCatalogReview extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['avatar'])) {
            ...
            $data['avatar'] = $review_info['avatar'];
        } else {
            $data['avatar'] = '';
        }
        ...
        } elseif (!empty($review_info) && is_file(DIR_IMAGE . $review_info['avatar'])) {
            $data['thumb'] = $this->model_tool_image->resize($review_info['avatar'], 100, 100);
        } else {
        ...
        if (isset($this->request->post['public'])) {
            ...
            $data['public'] = $review_info['public'];
        } else {
            $data['public'] = '';
        }
