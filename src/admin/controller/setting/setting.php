...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        $data['entry_dzen'] = $this->language->get('entry_dzen');
        $data['entry_youtube'] = $this->language->get('entry_youtube');
        $data['entry_rutube'] = $this->language->get('entry_rutube');
		...
		$data['entry_limit_photo'] = $this->language->get('entry_limit_photo');
		...
		$data['help_limit_photo'] = $this->language->get('help_limit_photo');
        ...
        if (isset($this->error['ogrn'])) {
            $data['error_ogrn'] = $this->error['ogrn'];
        } else {
            $data['error_ogrn'] = '';
        }
        ...
        if (isset($this->error['dzen'])) {
            $data['error_dzen'] = $this->error['dzen'];
        } else {
            $data['error_dzen'] = '';
        }
        ...
        if (isset($this->error['rutube'])) {
            $data['error_rutube'] = $this->error['rutube'];
        } else {
            $data['error_rutube'] = '';
        }
        ...
        if (isset($this->error['limit_photo'])) {
            $data['error_limit_photo'] = $this->error['limit_photo'];
        } else {
            $data['error_limit_photo'] = '';
        }
        ...
        if (isset($this->request->post['config_inn'])) {
            $data['config_inn'] = $this->request->post['config_inn'];
        } else {
            $data['config_inn'] = $this->config->get('config_inn');
        }

        if (isset($this->request->post['config_ogrn'])) {
            $data['config_ogrn'] = $this->request->post['config_ogrn'];
        } else {
            $data['config_ogrn'] = $this->config->get('config_ogrn');
        }
        ...
        if (isset($this->request->post['config_dzen'])) {
            $data['config_dzen'] = $this->request->post['config_dzen'];
        } else {
            $data['config_dzen'] = $this->config->get('config_dzen');
        }
        ...
        if (isset($this->request->post['config_rutube'])) {
            $data['config_rutube'] = $this->request->post['config_rutube'];
        } else {
            $data['config_rutube'] = $this->config->get('config_rutube');
        }
        ...
        if (isset($this->request->post['config_footer'])) {
            $data['config_footer'] = $this->request->post['config_footer'];
        } else {
            $data['config_footer'] = $this->config->get('config_footer');
        }
        ...
        if (isset($this->request->post['config_limit_photo'])) {
            $data['config_limit_photo'] = $this->request->post['config_limit_photo'];
        } else {
            $data['config_limit_photo'] = $this->config->get('config_limit_photo');
        }
	...
	protected function validate() {
        ...
        if (!$this->request->post['config_limit_photo']) {
            $this->error['limit_photo'] = $this->language->get('error_photo');
        }
