...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/lead')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_lead'),
                    'href'     => $this->url->link('catalog/lead', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'portfolio/poster')) {
                $portfolio[] = array(
                    'name'	   => $this->language->get('text_poster'),
                    'href'     => $this->url->link('portfolio/poster', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'portfolio/photo')) {
                $portfolio[] = array(
                    'name'	   => $this->language->get('text_photo'),
                    'href'     => $this->url->link('portfolio/photo', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'portfolio/video')) {
                $portfolio[] = array(
                    'name'	   => $this->language->get('text_video'),
                    'href'     => $this->url->link('portfolio/video', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
