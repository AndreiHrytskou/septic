...
class ControllerExtensionModuleReview extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/review', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/module/review', 'token=' . $this->session->data['token'], true);
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/review')) {
