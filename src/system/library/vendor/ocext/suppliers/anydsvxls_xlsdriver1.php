...
class anyDSVXLSxlsdriver1 {
    ...
    private $specification = array(
        'name' => "xlsdriver1",
        'id_specification' => "xlsdriver1___1_0_0_0",
        'version' => "1_0_0_0",
        'encoding' => 'UTF-8',
    );
    private $feed_cache = array(
            'status'=>0,
            'count_nodes'=>1000,
            'offers_file_name_prefix'=>'oanydsvxlsym_xlsdriver1_cache_',
            'categories_file_name_prefix'=>'oanydsvxlsym_xlsdriver1_cats_cache_',
            'offers_file_name_prefix_csv'=>'xlsdriver1_csv_'
    );
    ...
    public function viewData($template_data_on_step_one) {
        ...
        if(!isset($template_data_on_step_one['xlsdriver1_count_product_on_sec'])){
            
            $template_data_on_step_one['xlsdriver1_count_product_on_sec'] = $this->settings['count_product_on_sec'];
            
        }
        
        if(!isset($template_data_on_step_one['xlsdriver1_max_limit'])){
            
            $template_data_on_step_one['xlsdriver1_max_limit'] = $this->settings['max_limit'];
            ...
            foreach ($worksheet->getRowIterator() as $row) {
                ...
                if($start_row_this && $start_row_this < $this_rows){
                    ...
                    if( $this_index_rows >= $start && $this_index_rows < ($start+$limit) ){
                        ...
                        foreach ($cell_iterator as $column_index => $cell) {
                            ...
                            if ( !is_null($cell) ) {
                                ...
                                if($this_count_columns < $limit_columns){
                                    ...
                                    if($bgrcolor=='FF4F387F'){
                                        
                                        $category_root = TRUE;
                                        
                                    }
                                    elseif($bgrcolor=='FFFEEF33'){
                                        
                                        $category_2_level = TRUE;
                        ...
                        $rows[] = array('cells'=>$this_result_row,'bgrcolor'=>$bgrcolor,'category_2_level'=>$category_2_level,'category_root'=>$category_root,'count_not_empty_cells'=>count($this_result_row));

                        if(count($rows)>$max_total_count){
    ...
    public function feedToDSV($filename,$template_data){
        ...
        $this->feed_setting['delete_by_vendor'] = $this->getArrayByDelimeterAndString($template_data['xlsdriver1_delete_by_vendor']);
        
        $option_columns = $this->getArrayByDelimeterAndString($template_data['xlsdriver1_option_columns']);
        
        $attribute_columns = $this->getArrayByDelimeterAndString($template_data['xlsdriver1_attribute_columns']);
        
        $delete_columns = $this->getArrayByDelimeterAndString($template_data['xlsdriver1_delete_columns']);
        ...
        $this->feed_setting['option_value_by_column'] = $template_data['xlsdriver1_option_value_by_column'];
        
        $this->feed_setting['option_type'] = $template_data['xlsdriver1_option_type'];
        
        $this->feed_setting['params_as_column'] = $template_data['xlsdriver1_params_as_column'];
        
        if($template_data['xlsdriver1_max_curl_timeout'] && $template_data['xlsdriver1_max_curl_timeout']!=='' && $template_data['xlsdriver1_max_curl_timeout']<600){
            
            $this->settings['max_curl_timeout'] = $template_data['xlsdriver1_max_curl_timeout']*1000;
            
        }
        
        $this->feed_setting['option_whis_image'] = array();
        
        if(isset($template_data['xlsdriver1_option_whis_image'])){
            
            $this->feed_setting['option_whis_image'] = $this->getArrayByDelimeterAndString($template_data['xlsdriver1_option_whis_image']);
            
        }
        
        $this->feed_setting['xlsdriver1_group_id'] = '';
        
        if(isset($template_data['xlsdriver1_group_id']) && $template_data['xlsdriver1_group_id']!==''){
            
            $this->feed_setting['xlsdriver1_group_id'] = $template_data['xlsdriver1_group_id'];
            
        }
        
        $this->feed_setting['xlsdriver1_group_delete'] = array();
        
        if(isset($template_data['xlsdriver1_group_delete']) && $template_data['xlsdriver1_group_delete']!==''){
            
            $this->feed_setting['xlsdriver1_group_delete']['find'] = $this->getArrayByDelimeterAndString($template_data['xlsdriver1_group_delete']);
            
            $this->feed_setting['xlsdriver1_group_delete']['replace'] = array();
            
        }
        
        $this->feed_setting['xlsdriver1_group_id_write_to_id'] = FALSE;
        
        if(isset($template_data['xlsdriver1_group_id_write_to_id']) && $template_data['xlsdriver1_group_id_write_to_id']){
            
            $this->feed_setting['xlsdriver1_group_id_write_to_id'] = TRUE;
            
        }
        
        $this->feed_setting['xlsdriver1_product_id_column_name'] = '';
        
        if(isset($template_data['xlsdriver1_product_id_column_name']) && $template_data['xlsdriver1_product_id_column_name']!==''){
            
            $this->feed_setting['xlsdriver1_product_id_column_name'] = $template_data['xlsdriver1_product_id_column_name'];
            
        }
        
        $this->feed_setting['xlsdriver1_unit_not_write'] = FALSE;
        
        if(isset($template_data['xlsdriver1_unit_not_write']) && $template_data['xlsdriver1_unit_not_write']){
            
            $this->feed_setting['xlsdriver1_unit_not_write'] = TRUE;
            
        }
        
        
        $this->feed_setting['select_params_as_column'] = $this->getArrayByDelimeterAndString($template_data['xlsdriver1_select_params_as_column']);
        
        $this->feed_setting['delete_params'] = $this->getArrayByDelimeterAndString($template_data['xlsdriver1_delete_params']);
        
        $this->feed_setting['start_offer'] = (int)$template_data['xlsdriver1_start_offer'];
        ...
        $this->feed_setting['limit_offer'] = trim($template_data['xlsdriver1_limit_offer']);
        ...
        $result_xls = $this->getXlsRowsBySheetName($filename, $xls_param, 'Лист1', array());
        
        $first_columns = array("!A"=>"Артикул","!C"=>"Наименование","!R"=>"Количество","!Z"=>"Сумма1","!AJ"=>"Сумма2","!U"=>"Цена1","!AD"=>"Цена2");
        
        $categories = array();
        
        $category_locations = array('root'=>'!B','category_2_level'=>'!B');
        
        foreach ($result_xls as $i => $cell_info) {
            echo $cell_info['cells']['!C'].'<br>';
            if($cell_info['category_root'] && isset($cell_info['cells'][ $category_locations['root'] ])){
                
                $categories[0] = $cell_info['cells'][ $category_locations['root'] ];
                
            }
            elseif($cell_info['category_2_level'] && isset($cell_info['cells'][ $category_locations['category_2_level'] ])){
                
                $categories[1] = $cell_info['cells'][ $category_locations['category_2_level'] ];
                
            }
            elseif(count($cell_info['cells']) == 11){
                
                if(isset($cell_info['cells']['!C']) && $cell_info['cells']['!A']!=='' && $cell_info['cells']['!A']!=='Арт.'){
                    
                    $id = $cell_info['cells']['!C'];
                    
                    $status = 1;
                    
                    $this->feed_setting['offers'][$id]['categories'] = implode('/', $categories);
                    
                    $this->feed_setting['offers'][$id]['category_2_level'] = '';
                    
                    if(isset($categories[1])){
                        
                        $this->feed_setting['offers'][$id]['category_2_level'] = $categories[1];
                    ...
                    foreach ($first_columns as $excel_address => $name) {
                        ...
                        if(isset($cell_info['cells'][$excel_address])){
                            ...
                            if($name=='Категория' && $cell_info['cells'][$excel_address]=='Sale'){
    ...
    public function getCSVFromSource($filename,$template_data,$start=0,$limit=30){
        ...
        $xlsdriver1_categories_as_string = array();
        
        if(isset($template_data['xlsdriver1_categories_as_string']) && $template_data['xlsdriver1_categories_as_string']!==''){
            
            $xlsdriver1_categories_as_string = explode(PHP_EOL, $template_data['xlsdriver1_categories_as_string']);
            
            foreach ($xlsdriver1_categories_as_string as $key => $value) {
                
                $xlsdriver1_categories_as_string[$key] = html_entity_decode(trim(strtoupper($value)));
                
                if(!$xlsdriver1_categories_as_string[$key]){
                    unset($xlsdriver1_categories_as_string[$key]);
                }
                ...
                if(!$error && isset($product['code'])){
                    ...
                    foreach ($product as $field => $value) {
                        ...
                        if($field=='category'){
                            ...
                            if($xlsdriver1_categories_as_string){
                                
                                $skip_by_category = TRUE;
                                
                                foreach ($xlsdriver1_categories_as_string as $category) {
    ...
    public function getCMLParams($filename,$template_data,$tags,$count_nodes=1,$tags_new_names=array(),$start=0,$limit=100000,$file_name_cach_prefix,$selected_setting_id=''){
        ...
        /*
        $this->feed_setting['delete_by_category_id'] = $this->getArrayByDelimeterAndString($template_data['xlsdriver1_delete_by_category_id']);
    ...
    private function getDsvRowFromOfferNode($offer_row,$only_first_row=FALSE,$offers_file_name_prefix){
                ...
                foreach ($offer_row->param as $yml_param) {
                    ...
                    foreach ($attributes['@attributes'] as $attribute_name => $attribute_value) {
                        ...
                        if($attribute_name=='name' && !in_array((string)$attribute_value, $special_params)){
                            ...
                            if(isset($attributes['@attributes']['unit']) && !$this->feed_setting['xlsdriver1_unit_not_write']){
            ...
            if($this->feed_setting['xlsdriver1_group_id'] && isset($this->feed_setting['offers'][$id][$this->feed_setting['xlsdriver1_group_id']]) && $this->feed_setting['offers'][$id][$this->feed_setting['xlsdriver1_group_id']]!==''){
                
                $this_group_offer = $this->feed_setting['offers'][$id];
                
                $new_id_from_group_id = $this->feed_setting['offers'][$id][$this->feed_setting['xlsdriver1_group_id']];
                
                if($this->feed_setting['xlsdriver1_group_delete'] && isset($this_group_offer['name'])){
                    
                    $this_group_offer['name'] = str_replace($this->feed_setting['xlsdriver1_group_delete']['find'], $this->feed_setting['xlsdriver1_group_delete']['replace'], $this_group_offer['name']);
                ...
                if($this->feed_setting['xlsdriver1_group_id_write_to_id'] && $this->feed_setting['xlsdriver1_product_id_column_name']!==''){
                    
                    $this_group_offer[$this->feed_setting['xlsdriver1_product_id_column_name']] = $new_id_from_group_id;
