...
class anyDSVXLSeme54 { 
    ...
    private $specification = array(
        'name' => "eme54",
        'id_specification' => "eme54___1_0_0_0",
        'version' => "1_0_0_0",
        'encoding' => 'UTF-8',
    ...
    private $feed_cache = array(
            'status'=>0,
            'count_nodes'=>1000,
            'offers_file_name_prefix'=>'oanydsvxlsym_eme54_cache_',
            'categories_file_name_prefix'=>'oanydsvxlsym_eme54_cats_cache_',
            'offers_file_name_prefix_csv'=>'eme54_csv_'
    );
    ...
    public function viewData($template_data_on_step_one) {
        ...
        if(!isset($template_data_on_step_one['eme54_count_product_on_sec'])){
            
            $template_data_on_step_one['eme54_count_product_on_sec'] = $this->settings['count_product_on_sec'];
            
        }
        
        if(!isset($template_data_on_step_one['eme54_max_limit'])){
            
            $template_data_on_step_one['eme54_max_limit'] = $this->settings['max_limit'];
	...
	if(!strstr($xml_check, '<shop>')){
        ...
        $xml_replace = str_replace(
                array('<shop>',                          '</shop>',       'Разделы>',    'Раздел>',   'Название>', 'Код>', 'КодРодителя>',  'offers>',   'ДетальнаяЗапись>',   '<Характеристики>',   '</Характеристики>', 'Кодраздела>'), 
                array('<yml_catalog><shop2>',   '</shop2></yml_catalog>',  'categories>', 'category>', 'name>', 'id>',    'parent_id>', 'offers2>', 'element>', '', '', 'categoryId>'),
                $xml_replace);
        /*
        $xml_replace = str_replace(
                array('<photos','</photos>',                    '<photo','</photo>'), 
                array('<offers2','</offers2>', '<element ','</element>'),
                $xml_replace);
        
        $xml_replace = str_replace(
                array('<stores>','/<stores>','<gd','</gd>',                    '<photo','</photo>'), 
                array('<offers2>','</offers2>', '<element ','</element>'),
                $xml_replace);
        */
        ...
        $this->feed_setting['delete_by_vendor'] = $this->getArrayByDelimeterAndString($template_data['eme54_delete_by_vendor']);
        
        $option_columns = $this->getArrayByDelimeterAndString($template_data['eme54_option_columns']);
        
        $attribute_columns = $this->getArrayByDelimeterAndString($template_data['eme54_attribute_columns']);
        
        $delete_columns = $this->getArrayByDelimeterAndString($template_data['eme54_delete_columns']);
        ...
        $this->feed_setting['option_value_by_column'] = $template_data['eme54_option_value_by_column'];
        
        $this->feed_setting['option_type'] = $template_data['eme54_option_type'];
        
        $this->feed_setting['params_as_column'] = $template_data['eme54_params_as_column'];
        
        if($template_data['eme54_max_curl_timeout'] && $template_data['eme54_max_curl_timeout']!=='' && $template_data['eme54_max_curl_timeout']<600){
            
            $this->settings['max_curl_timeout'] = $template_data['eme54_max_curl_timeout']*1000;
            
        }
        
        $this->feed_setting['option_whis_image'] = array();
        
        if(isset($template_data['eme54_option_whis_image'])){
            
            $this->feed_setting['option_whis_image'] = $this->getArrayByDelimeterAndString($template_data['eme54_option_whis_image']);
            
        }
        
        $this->feed_setting['eme54_group_id'] = '';
        
        if(isset($template_data['eme54_group_id']) && $template_data['eme54_group_id']!==''){
            
            $this->feed_setting['eme54_group_id'] = $template_data['eme54_group_id'];
            
        }
        
        $this->feed_setting['eme54_group_delete'] = array();
        
        if(isset($template_data['eme54_group_delete']) && $template_data['eme54_group_delete']!==''){
            
            $this->feed_setting['eme54_group_delete']['find'] = $this->getArrayByDelimeterAndString($template_data['eme54_group_delete']);
            
            $this->feed_setting['eme54_group_delete']['replace'] = array();
            
        }
        
        $this->feed_setting['eme54_group_id_write_to_id'] = FALSE;
        
        if(isset($template_data['eme54_group_id_write_to_id']) && $template_data['eme54_group_id_write_to_id']){
            
            $this->feed_setting['eme54_group_id_write_to_id'] = TRUE;
            
        }
        
        $this->feed_setting['eme54_product_id_column_name'] = '';
        
        if(isset($template_data['eme54_product_id_column_name']) && $template_data['eme54_product_id_column_name']!==''){
            
            $this->feed_setting['eme54_product_id_column_name'] = $template_data['eme54_product_id_column_name'];
            
        }
        
        $this->feed_setting['eme54_unit_not_write'] = FALSE;
        
        if(isset($template_data['eme54_unit_not_write']) && $template_data['eme54_unit_not_write']){
            
            $this->feed_setting['eme54_unit_not_write'] = TRUE;
            
        }
        
        
        $this->feed_setting['select_params_as_column'] = $this->getArrayByDelimeterAndString($template_data['eme54_select_params_as_column']);
        
        $this->feed_setting['delete_params'] = $this->getArrayByDelimeterAndString($template_data['eme54_delete_params']);
        
        $this->feed_setting['start_offer'] = (int)$template_data['eme54_start_offer'];
        ...
        $this->feed_setting['limit_offer'] = trim($template_data['eme54_limit_offer']);
    ...
    public function getCSVFromSource($filename,$template_data,$start=0,$limit=30){
        ...
        $eme54_categories_as_string = array();
        
        if(isset($template_data['eme54_categories_as_string']) && $template_data['eme54_categories_as_string']!==''){
            
            $eme54_categories_as_string = explode(PHP_EOL, $template_data['eme54_categories_as_string']);
            
            foreach ($eme54_categories_as_string as $key => $value) {
                
                $eme54_categories_as_string[$key] = html_entity_decode(trim(strtoupper($value)));
                
                if(!$eme54_categories_as_string[$key]){
                    unset($eme54_categories_as_string[$key]);
                }
                ...
                if(!$error && isset($product['code'])){
                    ...
                    foreach ($product as $field => $value) {
                        ...
                        if($field=='category'){
                            ...
                            if($eme54_categories_as_string){
                                
                                $skip_by_category = TRUE;
                                
                                foreach ($eme54_categories_as_string as $category) {
    ...
    public function getCMLParams($filename,$template_data,$tags,$count_nodes=1,$tags_new_names=array(),$start=0,$limit=100000,$file_name_cach_prefix,$selected_setting_id=''){
        ...
        /*
        $this->feed_setting['delete_by_category_id'] = $this->getArrayByDelimeterAndString($template_data['eme54_delete_by_category_id']);
    ...
    public function getYMLCategories($filename,$template_data,$tags,$count_nodes=1,$tags_new_names=array(),$start=0,$limit=100000,$file_name_cach_prefix,$selected_setting_id=''){
        ...
        $this->feed_setting['set_products_by_category_id'] = $this->getArrayByDelimeterAndString($template_data['eme54_set_products_by_category_id']);
    ...
    private function getDsvRowFromOfferNode($offer_row,$only_first_row=FALSE,$offers_file_name_prefix){
            ...
            if(isset($offer_row->{'Характеристика'})){

                foreach ($offer_row->{'Характеристика'} as $property) {
            ...
            if(isset($offer_row->{'Основноеизображение'})){
                
                $picture = (string)$offer_row->{'Основноеизображение'};
            ...
            if(isset($offer_row->{'Дополнительныеизображения'})){
                
                $pictures_obj = $offer_row->{'Дополнительныеизображения'};
                
                if(isset($pictures_obj->{'Изображение'})){
                    
                    foreach ($pictures_obj->{'Изображение'} as $pictures_xml) {
                    
                        foreach ($pictures_xml->URL as $picture){
            ...
            if(isset($offer_row->category)){
                ...
                foreach ($offer_row->category as $category) {
                    
                    $attributes = (array)$category->attributes();
                    
                    if(isset($attributes["@attributes"]['label'])){
                        
                        $categories[] = $attributes["@attributes"]['label'];
                ...
                foreach ($offer_row->param as $yml_param) {
                    ...
                    foreach ($attributes['@attributes'] as $attribute_name => $attribute_value) {
                        ...
                        if($attribute_name=='name' && !in_array((string)$attribute_value, $special_params)){
                            ...
                            if(isset($attributes['@attributes']['unit']) && !$this->feed_setting['eme54_unit_not_write']){
            ...
            if(isset($offer_row->{'ДополнительноеОписаниеНоменклатуры'})){
                
                if(strstr((string)$offer_row->{'ДополнительноеОписаниеНоменклатуры'}, '[CDATA[')){
                    
                    $description = trim(html_entity_decode(str_replace(array('&lt;![CDATA[',']]&gt;',']]>', ' ]]&gt;'), array('','','',''), (string)$offer_row->{'ДополнительноеОписаниеНоменклатуры'})));
                    
                }else{
                    
                    $description = (string)$offer_row->{'ДополнительноеОписаниеНоменклатуры'};
            ...
            */
            ...
            if($this->feed_setting['eme54_group_id'] && isset($this->feed_setting['offers'][$id][$this->feed_setting['eme54_group_id']]) && $this->feed_setting['offers'][$id][$this->feed_setting['eme54_group_id']]!==''){
                
                $this_group_offer = $this->feed_setting['offers'][$id];
                
                $new_id_from_group_id = $this->feed_setting['offers'][$id][$this->feed_setting['eme54_group_id']];
                
                if($this->feed_setting['eme54_group_delete'] && isset($this_group_offer['name'])){
                    
                    $this_group_offer['name'] = str_replace($this->feed_setting['eme54_group_delete']['find'], $this->feed_setting['eme54_group_delete']['replace'], $this_group_offer['name']);
                ...
                if($this->feed_setting['eme54_group_id_write_to_id'] && $this->feed_setting['eme54_product_id_column_name']!==''){
                    
                    $this_group_offer[$this->feed_setting['eme54_product_id_column_name']] = $new_id_from_group_id;
