...
<select id='export_boxes_selector' style="margin-bottom: 10px;" onchange="$('.export_boxes').hide();$('#export_box2_'+this.value).show();" name="odmpro_tamplate_data[export_format_selected]" class="form-control">
...
<div class="input-group export_boxes"  style="width: 100%" id="export_box2_xls">
